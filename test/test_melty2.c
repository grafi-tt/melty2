...
int main(void) {
    ...
    n_err += check_number32("ctr=0", result8[0], UINT32_C(0x0de3c4a9));
    n_err += check_number32("ctr=1", result8[1], UINT32_C(0x178c8ff3));
    n_err += check_number32("ctr=2", result8[2], UINT32_C(0x4f74fd76));
    n_err += check_number32("ctr=3", result8[3], UINT32_C(0x176786db));
    n_err += check_number32("ctr=4", result8[4], UINT32_C(0xd53c303f));
    n_err += check_number32("ctr=5", result8[5], UINT32_C(0x9879cd53));
    n_err += check_number32("ctr=6", result8[6], UINT32_C(0x473888c2));
    n_err += check_number32("ctr=7", result8[7], UINT32_C(0x2da7f855));
